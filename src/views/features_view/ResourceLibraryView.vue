...
const resources = ref<Resource[]>([
  {
    id: 1,
    title: 'Basic Calculus for First Year Students',
    type: 'ebook',
    subject: 'math',
    description: 'E-book covering basic calculus content for first year students',
    author: 'Dr. Somchai Meesuk',
  ...
  },
  {
    ...
    type: 'video',
    subject: 'computer',
    description: 'Video tutorial on Python programming for beginners covering all basics',
    author: 'Prof. Wichai Technology',
  ...
  },
  {
    ...
    type: 'document',
    subject: 'science',
    description: 'เอกสารสรุปเนื้อหาวิชาฟิสิกส์Allในระดับมหาวิทยาลัย',
