  ...
  <div class="max-w-5xl mx-auto space-y-6 p-6">
    ...
    <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
        ...
        <div v-for="(card, index) in cards" :key="card.id" class="space-y-3">
          ...
          <div class="space-y-3">
            <div class="border border-gray-200 rounded-lg p-4 bg-white">
              <label class="block text-xs font-medium text-gray-600 mb-2 uppercase tracking-wide">Front Side</label>
              <textarea
                v-model="card.front"
            ...
            <div class="border border-gray-200 rounded-lg p-4 bg-gray-50">
              <label class="block text-xs font-medium text-gray-600 mb-2 uppercase tracking-wide">Back Side</label>
              <textarea
                v-model="card.back"
      ...
      <div v-if="cards.length === 0" class="text-center py-12">
        ...
        <p class="text-gray-600 mb-4">Start building your flashcard deck by adding your first card.</p>
        <button
...
const handleSave = () => {
  ...
  console.log('Saving:', flashcardDeck)
  props.onBack()
}
</script>
