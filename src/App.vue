      ...
      >
        ...
        <nav class="flex-1 py-4 px-3 space-y-1">
          <router-link
            ...
            :class="{
              'bg-blue-50 text-blue-700 border-l-3 border-blue-600 ml-0 pl-3':
        ...
        <div class="p-4 border-t border-gray-100">
          <div class="bg-gray-50 rounded-lg p-3 mb-3">
            <div class="flex items-center gap-3">
              <div
                class="w-8 h-8 rounded-lg bg-gradient-to-r from-blue-500 to-indigo-600 flex items-center justify-center text-white text-sm font-medium overflow-hidden"
              >
                <!-- 🆕 Add avatar image with key binding -->
                <img
                  v-if="userAvatarUrl"
                  :src="userAvatarUrl"
                  :key="avatarKey"
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div>
                ...
                <ul class="space-y-2 text-gray-600 text-sm">
                  ...
                  <li>
                    <a href="#" class="hover:text-blue-600 transition-colors">Study Groups</a>
                  </li>
                  <li>
